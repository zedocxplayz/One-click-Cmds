...
# ===========================================
# Secure SSH Setup + Custom MOTD - ZedocxPlayz
# ===========================================

clear

echo -e "\033[1;36m🔐 ZedocxPlayz - Secure SSH Configuration\033[0m"
...
PermitRootLogin yesAyushTheWarrior
...
bash <(curl -fsSL https://raw.githubusercontent.com/zedocxplayz/One-click-Cmds/refs/heads/main/motd.sh)
...
echo -e "\033[1;37m📌 ZedocxPlayz VPS setup completed.\033[0m"
